...
export default function Layout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="flex flex-col h-screen place-items-center">
            <nav className="navbar max-w-screen-lg bg-primary text-primary-content rounded-b-lg">
            ...
            <main className="flex-1 max-w-screen-lg">{children}</main>
            <footer className="footer max-w-screen-lg bg-neutral text-neutral-content rounded-t-lg p-5 pb-3 justify-center md:justify-between place-items-center ">
                <div className="grid-flow-col-dense ">
                    <span className="btn btn-secondary btn-xs btn-ghost no-animation">
                        Onkar Deshpande
                    </span>
                </div>
                ...
                <div className="grid-flow-col-dense ">
                    <Link href={'/CV.pdf'} passHref>
                        <a
                            className="btn btn-secondary btn-xs btn-ghost"
                            target="_blank"
                        >
                            Resume
                        </a>
