...
function Navbar() {
    return (
        <nav className="navbar bg-primary text-primary-content rounded-b-lg">
...
function Footer() {
    return (
        <footer className="footer footer-center md:footer md:justify-between gap-4 bg-neutral text-neutral-content rounded-t-lg p-4">
